...
try{
 for(const mobile of [false,true]){
  ...
  await gallery.getByRole('button',{name:'Open Jewellery in motion'}).waitFor({timeout:30000})
  ...
  await gallery.getByRole('button',{name:'Open Jewellery in motion'}).click()
  const dialog=page.getByRole('dialog',{name:'Jewellery in motion'})
  ...
  await gallery.getByRole('button',{name:'Open LPOOP'}).click()
  const game=page.locator('iframe[title="LPOOP playable game"]')
